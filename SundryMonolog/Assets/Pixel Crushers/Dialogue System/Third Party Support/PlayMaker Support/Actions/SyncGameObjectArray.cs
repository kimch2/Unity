    ...
    public class SyncGameObjectArray : FsmStateAction
    {
        ...
        private void Sync()
        {
            ...
            else
            {
                ...
                {
                    playMakerVariable.Values = DialogueSystemPlayMakerTools.StringToArray(DialogueLua.GetVariable(dialogueSystemVariable.Value).AsString, VariableType.GameObject);
                }
            }
        }
